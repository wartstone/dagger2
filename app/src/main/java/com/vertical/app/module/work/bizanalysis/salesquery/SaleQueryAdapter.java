...
/**
 * Created by ls on 12/20/17.
 */


public class SaleQueryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public String TAG = getClass().getSimpleName();
    private OnItemClickListener onItemClickListener;
    private List<SaleRecordBean> mData;

    public SaleQueryAdapter(){
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        SaleRecordBean memberBean = mData.get(position);
